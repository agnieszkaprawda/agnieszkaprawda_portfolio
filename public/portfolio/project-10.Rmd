...
project_images:
title: Estimation Engine for London House Prices with Stacked Final Model using Tree Models, LASSO, Random Forest & GBM 
type: portfolio
---
```{css echo=FALSE}
...
<ul>
<li>`is_district` : that will have value "TRUE" for the most expensive districts and "FALSE" for the rest</li>
<li>`is_station` : that will take the value "TRUE" for the station where house price was above 2,000,000.</li>
<li>`is_postcode` : that will take the value "TRUE" for the postcode_short where house price exceeded 2,000,000.</li>
</ul>
...
## F-statistic:  188 on 282 and 10216 DF,  p-value: <2e-16
...
In this section I will use the best algorithm I identified to choose 200 properties from the out of sample data. I will report 20 first raws of my original dataset with the scores.
